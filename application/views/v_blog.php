	...
	<div id="fh5co-page">
				...
				<div class="header-inner">
					...
					<nav role="navigation">
						<ul>
							...
							<li class="active"><a href="<?php echo base_url() . 'artikel' ?>">News</a></li>
		...
		<aside id="fh5co-hero" clsas="js-fullheight">
			<div class="flexslider js-fullheight">
				<ul class="slides">
					<li style="background-image: url(<?php echo base_url() . 'theme/images/blog-1.jpg' ?>);">
						<div class="overlay-gradient"></div>
						<div class="container">
							<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
								<div class="slider-text-inner">
									<h2 style="text-shadow: 2px 3px 1px black">Our News</h2>
								</div>
							</div>
						</div>
					</li>
