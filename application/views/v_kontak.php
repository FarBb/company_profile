						...
						<div class="container">
							<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
								<div class="slider-text-inner">
									<h2 style="text-shadow: 2px 3px 1px black">Contact Us Here</h2>
									<p class="fh5co-lead " style="text-shadow: 2px 3px 1px black">We are ready to serve you 1 x 24 hours</p>
								</div>
							</div>
						</div>
					</li>
				...
				<div class="row">
					<div class="col-md-3">
						...
						<ul class="contact-info">
							<li><i class="icon-map"></i>Ruko A JL. Raden Intan RT.003 RW.004 Arjosari-Blimbing Kota Malang Jawa Timur</li>
							<li><i class="icon-phone"></i>(+62) 812-3213-9950</li>
							<li><i class="icon-envelope"></i><a href="#">monsurin@gmail.com</a></li>
							<li><i class="icon-globe"></i><a href="#">www.monsurin.com</a></li>
						</ul>
					</div>
